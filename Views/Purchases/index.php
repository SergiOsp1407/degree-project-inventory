            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input id="amount" type="number" class="form-control" name="amount" onkeyup="calculatePrice(event)">
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
...
<div class="row">
    <div class="col-md-4 ml-auto">
        <div class="form-group">
            ...
            <button class="btn btn-primary mt-2 btn-block" type="button" onclick="triggerPurchase()">Generar compra</button>
        </div>        
    </div>
</div>
